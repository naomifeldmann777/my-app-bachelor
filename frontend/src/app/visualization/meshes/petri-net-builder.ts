...
export class PetriNetBuilder {
    ...
    static buildNet(container: THREE.Object3D, petriNet: PetriNetModel): {
        ...
        petriNet.places.forEach(place => {
            ...
            // Add the place mesh to the container (scene or group)
            container.add(placeMesh.mesh);
        ...
        petriNet.transitions.forEach(transition => {
            ...
            // Add the transition mesh to the container (scene or group)
            container.add(transitionMesh.mesh);
